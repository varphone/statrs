...
mod test {
    ...
    fn test_case<F>(location: f64, scale: f64, expected: f64, eval: F)
        where F: Fn(laplace::Laplace) -> f64
    {
        let n = try_create(location, scale);
        let x = eval(n);
    ...
    fn test_variance()
    {
        ...
        test_almost(f64::INFINITY, f64::INFINITY, f64::INFINITY,  1E-12, |l| l.variance());
    }

    #[test]
    fn test_stddev()
    {
        test_almost(f64::NEG_INFINITY, 0.1, f64::consts::SQRT_2*0.1,  1E-12, |l| l.std_dev());
        ...
        test_almost(f64::INFINITY, f64::INFINITY, f64::INFINITY,  1E-12, |l| l.std_dev());
    }

    #[test]
    fn test_entropy()
    {
        test_almost(f64::NEG_INFINITY, 0.1, f64::ln(2.0*f64::consts::E*0.1), 1E-12, |l| l.entropy());
        test_almost(-6.0, 1.0, f64::ln(2.0*f64::consts::E), 1E-12, |l| l.entropy());
        test_almost(1.0, 7.0, f64::ln(2.0*f64::consts::E*7.0), 1E-12, |l| l.entropy());
        test_almost(5.0, 10.0, f64::ln(2.0*f64::consts::E*10.0), 1E-12, |l| l.entropy());
        test_almost(f64::INFINITY, f64::INFINITY, f64::INFINITY, 1E-12, |l| l.entropy());
    ...
    fn test_ln_density()
    {
        ...
        test_case(f64::NEG_INFINITY, 0.1, f64::NEG_INFINITY,|l| l.ln_pdf(-0.0));
        ...
        test_case(f64::NEG_INFINITY, 0.1, f64::NEG_INFINITY,|l| l.ln_pdf(15.0));
