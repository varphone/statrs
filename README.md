...
Please check out the documentation [here](https://docs.rs/statrs/0.6.0/statrs/)
...
Statrs v0.6.0 comes with a number of commonly used distributions including Normal, Gamma, Student's T, Exponential, Weibull, etc.
